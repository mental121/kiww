...
$baseAuthor = $BRAND;
$URL  =  "https://ft.untidar.ac.id/app/?haha=$BRAND";
$PAGEURL = "https://ft.untidar.ac.id/app/?haha=$BRAND";
$AMP = "https://wkwkaja.pages.dev/app/?haha=$BRAND";
$DAFTAR = "https://wkwkaja.pages.dev/app/";
$BANNER = "https://smily.one/nn/ase.webp";
$LOGO = "https://smily.one/pic/31.png";
$keyword = "$brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND 🥜 Fakultas Teknik Universitas Tidar";
    $DESCRIPTION = "$BRAND sebuah fakultas yang berada di lingkungan perguruan tinggi negeri di Magelang, Jawa Tengah, yaitu Universitas Tidar (UNTIDAR).";
    $description = "$BRAND sebuah fakultas yang berada di lingkungan perguruan tinggi negeri di Magelang, Jawa Tengah, yaitu Universitas Tidar (UNTIDAR).";
}
